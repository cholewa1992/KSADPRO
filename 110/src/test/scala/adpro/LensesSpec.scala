...
class LensesSpec extends FlatSpec with Checkers {
  ...
  "codiag2[Int]" should behave like veryWellBehavedTotalLense (codiag2[Int])
  "codiag2[String]" should behave like veryWellBehavedTotalLense (codiag2[String])
...
class LensesSuite extends FunSuite with Discipline {
  ...
  checkAll("codiag[Int]", monocle.law.discipline.LensTests(codiag[Int]))
  checkAll("codiag1[Int]", monocle.law.discipline.LensTests(codiag1[Int]))
  checkAll("codiag2[Int]", monocle.law.discipline.LensTests(codiag2[Int]))
  checkAll("codiag[String]", monocle.law.discipline.LensTests(codiag[String]))
  checkAll("codiag1[String]", monocle.law.discipline.LensTests(codiag1[String]))
  checkAll("codiag2[String]", monocle.law.discipline.LensTests(codiag2[String]))
